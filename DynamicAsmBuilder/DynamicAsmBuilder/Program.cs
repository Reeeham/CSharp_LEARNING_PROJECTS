...
namespace DynamicAsmBuilder
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Assembly a = Assembly.Load("MyAssembly");//late binding
        ...
        private static void CreateMyAsm(AppDomain currAppDomain)
        {
            ...
            FieldBuilder msgField = helloWorldClass.DefineField("the message", Type.GetType("System.String"),FieldAttributes.Private);
